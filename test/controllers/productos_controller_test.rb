...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { cantidad_almacen: @producto.cantidad_almacen, descripcion: @producto.descripcion, fabricante: @producto.fabricante, fecha_alta: @producto.fecha_alta, nombre: @producto.nombre }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { cantidad_almacen: @producto.cantidad_almacen, descripcion: @producto.descripcion, fabricante: @producto.fabricante, fecha_alta: @producto.fecha_alta, nombre: @producto.nombre }
    assert_redirected_to producto_path(assigns(:producto))
  end
